...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ci6ylwm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ci6ylwm.containers.anotherwebservice.com/
...
```
git clone git@github.com:BlindHunter95/container-ci6ylwm.git
cd container-ci6ylwm
```
...
```
docker attach container-ci6ylwm
```
